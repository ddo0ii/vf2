...
exports.onCreateBoardArticle = functions
  ...
  .onCreate(async (snap, context) => {
    ...
    try {
      const r = await index.saveObject(algoliaDoc, {
...
exports.onUpdateBoardArticle = functions
  ...
  .onUpdate(async (change, context) => {
    ...
    await index
      .partialUpdateObject(algoliaDoc)
      .catch((e) => console.error("algolia update err: " + e.message));
  });
